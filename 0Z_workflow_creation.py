...
job_config = {
    ...
    "git_source": {
        "git_url": "https://github.com/souvik-databricks/dbrx-llm-demo",
        "git_provider": "gitHub",
        "git_branch": "main",
    },
    "parameters": [
...
# delete job
# job_id = [i for i in w.jobs.list(name=f"({username}) cme_llm_demo")][0].job_id
